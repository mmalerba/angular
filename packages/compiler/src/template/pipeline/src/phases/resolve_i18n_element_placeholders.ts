      ...
      switch (op.kind) {
        ...
        case ir.OpKind.ElementStart:
          ...
          if (op.i18nPlaceholder !== undefined) {
            ...
            addParam(
                currentOps.i18nContext.params, startName, op.slot.slot!,
        ...
        case ir.OpKind.ElementEnd:
          ...
          if (startOp && startOp.i18nPlaceholder !== undefined) {
            ...
            if (closeName !== '') {
              addParam(
                  currentOps.i18nContext.params, closeName, startOp.slot.slot!,
        ...
        case ir.OpKind.Template:
          ...
          if (op.i18nPlaceholder !== undefined) {
            ...
            addParam(
                currentOps.i18nContext.params, op.i18nPlaceholder.startName, op.slot.slot!,
                subTemplateIndex, ir.I18nParamValueFlags.TemplateTag);
            addParam(
                currentOps.i18nContext.params, op.i18nPlaceholder.closeName, op.slot.slot!,
                subTemplateIndex,
