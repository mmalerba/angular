...
export interface I18nExpressionOp extends Op<UpdateOp>, ConsumesVarsTrait,
  ...
  /**
   * The slot for the i18n block this expression belongs to.
   */
  i18nSlot: SlotHandle;
...
export function createI18nExpressionOp(
    context: XrefId, target: XrefId, i18nSlot: SlotHandle, expression: o.Expression,
...
export function createI18nApplyOp(
    target: XrefId, i18nSlot: SlotHandle, sourceSpan: ParseSourceSpan): I18nApplyOp {
  return {
    kind: OpKind.I18nApply,
    target,
    i18nSlot,
