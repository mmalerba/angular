 ...
 */
export type UpdateOp = ListEndOp<UpdateOp>|StatementOp<UpdateOp>|PropertyOp|StylePropOp|ClassPropOp|
    StyleMapOp|ClassMapOp|InterpolatePropertyOp|InterpolateStylePropOp|InterpolateStyleMapOp|
    InterpolateClassMapOp|AttributeOp|InterpolateTextOp|AdvanceOp|VariableOp<UpdateOp>;
